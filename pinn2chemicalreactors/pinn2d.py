...
class pinn2d:
	...
	# Counter
        ...
        self.x2f_tf = tf.placeholder(tf.float32, shape=[None, self.x2f.shape[1]])

        # Neural networks: predict solution and residuals
        self.u_pred = self.net_u(self.x1_tf, self.x2_tf)
        self.f_pred = self.net_f(self.x1f_tf, self.x2f_tf)
    ...
    def train(self,nIter):
        ...
        tf_dict = {self.x1_tf: self.x1, self.x2_tf: self.x2, self.u_tf: self.u, self.x1f_tf: self.x1f, self.x2f_tf: self.x2f}
    ...
    def predict(self, X_star):
        ...
        tf_dict = {self.x1_tf: X_star[:,0:1], self.x2_tf: X_star[:,1:2], self.x1f_tf: X_star[:,0:1], self.x2f_tf: X_star[:,1:2]}
    ...
    def net_f(self, x1, x2):
        ...
        if (self.problem == 'AcetoAcetylation'):
            return self.net_f_AcetoAcetylation(x1, x2)
        elif (self.problem == 'TolueneHydrogenation'):
            return self.net_f_TolueneHydrogenation(x1)
        elif (self.problem == 'AllylChlorination'):
            return self.net_f_AllylChlorination(x1, x2)


    def net_f_AcetoAcetylation(self, t, Qin):
    ...
    def net_f_AllylChlorination(self, V, T):
